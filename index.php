...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['admin_login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $admin['password'])) {
            ...
            // No redirect needed - the admin section will show on refresh
        } else {
  ...
  <div class="container">
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="admin.php" onclick="openAdminLogin()"><i class="fas fa-user-cog"></i> Admin</a></li>
        </ul>
      </nav>
    </header>
    ...
    <div class="main-content">
              ...
              <div class="form-group">
                ...
                <div class="bundle-grid">
                  ...
                  <div class="bundle-option" data-bundle="25GB">
                    ...
                    <div class="bundle-price">GH₵ 109.50</div>
                  </div>
      ...
      <div class="card">
        ...
        <p>All payments are processed through secure payment gateway. <p> We never store your payment details.</p> </p>
    ...
    <!-- Admin Login Section -->
    <div class="card admin-login" id="adminLogin" style="display: none;">
...
function openAdminLogin() {
  ...
  if (adminLogin.style.display === 'block') {
    ...
    function payWithPaystack() {
      ...
      const tempEmail = 'customer_' + Math.random().toString(36).substring(2, 11) + 'antwitr.97@gmail.com';
      
      const handler = PaystackPop.setup({
        key: 'pk_live_fb10659567aa8cf4166135eaf4142103fd6dfd55', // Test public key
        email: tempEmail,
